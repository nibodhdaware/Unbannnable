...
function AppPageContent() {
    ...
    const filteredSubreddits = useMemo(() => {
        ...
        // Prioritize API search results, then fallback to Fuse.js local search
        if (searchResults.length > 0) {
            return searchResults;
        }

        // When there's a search query but no API results yet, use Fuse.js search results
        ...
        return fuseResults;
    }, [fuse, searchQuery, allSubreddits, subreddits, searchResults]);
    ...
    // Debounced search effect - calls API when user types
    useEffect(() => {
        const debounceTimer = setTimeout(async () => {
            if (searchQuery.trim().length >= 2) {
                try {
                    setLoadingSearch(true);
                    const results = await redditAPI.searchSubreddits(
                        searchQuery,
                        20,
                    );
    ...
    const handleSearchChange = async (value: string) => {
        ...
        setSelectedIndex(-1);
        // Don't set subreddit until selection is confirmed
        // The API search effect will trigger automatically through the useEffect
    };
                ...
                {showPricingPopup && (
                    ...
                    >
                        <motion.div
                            ...
                            className="max-w-7xl w-full my-8"
                        ...
                        >
                            ...
                            <div className="text-center mb-8">
                                <Badge className="mb-4 bg-[#FF4500] text-white hover:bg-[#e03d00]">
                                ...
                                <p className="text-gray-300">
                                    Get monthly AI credits forever. No
                                        ...
                                        <button
                                            onClick={() => {
                                                ...
                                                handleGetStarted(
                                                    "starter",
                                                    process.env
                                                        .NEXT_PUBLIC_DODO_STARTER_PRODUCT_ID ||
                                        ...
                                        <button
                                            onClick={() => {
                                                ...
                                                handleGetStarted(
                                                    "standard",
                                                    process.env
                                                        .NEXT_PUBLIC_DODO_STANDARD_PRODUCT_ID ||
