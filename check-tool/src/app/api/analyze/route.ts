...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("Received request:", { postText: postText?.substring(0, 50), subreddit });
    ...
    if (!process.env.GOOGLE_GEMINI_API_KEY) {
      ...
      return NextResponse.json(
        { 
          ...
          details: "Please add GOOGLE_GEMINI_API_KEY environment variable in Vercel project settings",
